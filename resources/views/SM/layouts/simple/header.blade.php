<div class="page-header">
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a><img class="img-fluid" src="{{asset('assets/images/logo/logo.png')}}" alt=""></a></div>
      ...
      <ul class="nav-menus">
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            <img class="b-r-10" width="40px" src="{{ Auth::user()->photo != null ? asset('images/logo/'.Auth::user()->photo) : asset('assets/img/user.jpg') }}" alt="">
            <div class="media-body">
              <span>{{Auth::user()->agent->nama_agent}}</span>
              <p class="mb-0 font-roboto">Admin Sales Manager<i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
